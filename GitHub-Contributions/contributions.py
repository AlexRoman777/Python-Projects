...
def history(user, contributions):
    with open("GitHub-Contributions/data/history.csv", "r") as file:
...
def main():
    ...
    with open("GitHub-Contributions/DevOps22.md", "w") as file:
    ...
    with open("GitHub-Contributions/data/history.csv", "w") as file:
